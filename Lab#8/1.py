...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("Coin.jpg")  # Load a coin image
...
# Line 56 now contains a new class, called Coin
# Also, i have created a new sprite group called coins, which contains the coin object
# The coin object is created and added to the all_sprites group
# Count of coins is displayed on the screen, with the help of 120 line of code