...
if COIN_SCORE % 5 == 0 and COIN_SCORE != 0:
    SPEED += 0.5  # Increase speed every 5 coins collected
...
while True:
    ...
    if coins:
        ...
        if collided_coin:
            COIN_SCORE += collided_coin.value
...
#Randomly generated coins: 69-71
#Increase the speed of enemy every 5 coins:103-104